...
namespace SS3D.Systems.Tile
{
    ...
    public class TileChunk: NetworkBehaviour
    {
        ...
        public void SetTileObject(TileLayer layer, int x, int y, TileObject value)
        {
            ...
            {
                Punpun.Yell(Subsystems.Get<TileSubsystem>(), "Tried to set tile object outside of chunk boundary");
            }
        }
        ...
        public TileObject GetTileObject(TileLayer layer, int x, int y)
        {
            ...
            {
                Punpun.Yell(Subsystems.Get<TileSubsystem>(), "Tried to get tile object outside of chunk boundary");
                return default;
            }
        }
